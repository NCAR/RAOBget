################################################################################
#
# This python dictionary stores the list of stations available via the University
# of Wyoming Radiosonde data archive. The station identifier (id or number) is
# used in the retrieval URL, e.g.
